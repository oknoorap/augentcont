...
function getFilesPath(){
  $ret = substr($_SERVER['SCRIPT_NAME'], 0, strpos($_SERVER['SCRIPT_NAME'], basename($_SERVER['SCRIPT_NAME'])));
  $ret = dirname(dirname(dirname(dirname(dirname($ret)))));
  $ret .= '/' . FILES_ROOT;
  //$ret = RoxyFile::FixPath(FILES_ROOT);

...
if (! is_login()) die('Hacker you\'re drunk!');
...
<div id="dlgAddFile">
  <form name="addfile" id="frmUpload" method="post" target="frmUploadFile" enctype="multipart/form-data">
    ...
    <div class="form"><br />
      <input type="file" name="files[]" id="fileUploads" onchange="if(this.files && this.files.length > 0)listUploadFiles(this.files)" multiple="multiple" />

...
<head>
	...
	<link rel="search" type="application/opensearchdescription+xml" title="<?php echo domain(); ?> Search" href="<?php echo base_url(); ?>search.xml" />
	<?php if(location('result')): ?>
	<meta name="keywords" content="<?php echo title(true); ?>">
	<?php endif; ?>
	<?php if(location('home') ||location('category') ||location('result') || location('single')): ?>
				...
				<div class="small-12 columns">
					<div class="row" id="logo">
						<div class="small-3 columns">
							<a href="<?php echo base_url(); ?>"><img src="<?php echo theme_url(); ?>public/img/logo.png" width="300" height="80"></a>
						</div>

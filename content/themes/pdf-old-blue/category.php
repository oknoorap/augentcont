			...
			<div itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
				...
				?>
					<div itemprop="item" itemscope itemtype="http://schema.org/Thing" class="document">
						<div class="doc-thumb">
							<a href="<?php echo $read; ?>" rel="nofollow"><img src="<?php echo theme_url(); ?>img/thumbload.gif" width="85" height="113" data-src="<?php echo $doc['url']; ?>" alt="<?php echo $doc['title']; ?> screnshot preview"></a>
						</div>
						<div class="doc-title" itemprop="name">
							<a href="<?php echo $link; ?>"><?php echo $doc['title']; ?></a>
						</div>
						<div class="doc-description" itemprop="description">
							<?php echo $doc['description']; ?>
						</div>
						<div class="doc-info">
							<a itemprop="url" href="<?php echo $read; ?>" rel="nofollow"><i class="fa fa-book"></i> Read</a> | <i class="fa fa-clock-o"></i> Date: <?php echo date('d M Y', $doc['time']); ?>
						</div>
					</div>
